...
<div class="max-w-lg mx-auto">
        ...
        <div class="bg-gradient-to-r from-blue-600 to-purple-600 px-8 py-6 text-center">
            <div class="flex flex-col items-center space-y-4">
                ...
                <div class="text-white">
                    <h2 class="text-2xl font-bold">{{ $tenant->name ?? 'Creator' }}</h2>
                    <p class="text-blue-100 text-sm">Members Only Content</p>
                </div>
            </div>
        </div>
    ...
    <div class="mt-8 text-center">
        <div class="text-sm text-gray-600">
            <p class="mb-2">Not subscribed to {{ $tenant->name ?? 'this channel' }} yet?</p>
